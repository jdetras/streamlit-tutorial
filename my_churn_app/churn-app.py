...
#download data that trained model
...
#define function to download read-in data
def filedownload(df):
...
#add sidebar selectbox for categorical
#def user_input_features():
...
#call function and store as input
...
#generate binary scores and probs
